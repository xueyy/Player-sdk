...
function loadscript(type) {
    if (type === 'haikang') {
        ...
        oScript.src = "https://cdn.jsdelivr.net/gh/xueyy/Player-sdk@master/ezuiplayer.js";
        document.body.appendChild(oScript);
    } else if (type === 'lecheng') {
        var oScript = document.createElement("script");
        oScript.type = 'application/javascript';
        oScript.src = "https://cdn.jsdelivr.net/gh/xueyy/Player-sdk@master/imouplayer-beta.js"
        document.body.appendChild(oScript);
    }
}
