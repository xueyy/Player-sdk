! function (e) {
    ...
    var r = t(1),
        ...
        A = function (e, n, t) {
            ...
            for (l in p && (t = n), t) u = ((c = !f && g && void 0 !== g[l]) ? g : t)[l], v = j && c ? a(u, r) : h && "function" == typeof u ? a(Function.call, u) : u, g && s(g, l, u, e & A.U), b[l] != u && i(b, l, v), h && m[l] != u && (m[l] = u)
        };
    ...
    t(13).inspectSource = function (e) {
        ...
        l && (i(t, "name") || o(t, "name", n)), e[n] !== t && (l && (i(t, s) || o(t, s, e[n] ? "" + e[n] : A.join(String(n)))), e === r ? e[n] = t : a ? e[n] ? e[n] = t : o(e, n, t) : (delete e[n], o(e, n, t)))
    ...
    (function (e, r) {
        ...
        (function () {
            ...
            var y = function e(n) {
                ...
                var a, A, l, c, v, f = r ? !!o.likeChrome : /\bChrome\b/.test(n) && !/internal|\n/i.test(p.toString()),
                    ...
                    R = function (e) {
                        return m(e, (function (e, t, r) {
                            return e || (t[Q] || t[/^[a-z]+(?: +[a-z]+\b)*/i.exec(Q)] || RegExp("\\b" + b(r) + "(?:\\b|\\w*\\d)", "i").exec(n)) && r
                        }))
                    }({
                        Apple: {
                            iPad: 1,
                ...
                }), (a = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(B)) && !/\bi686\b/i.test(B) ? (Z && (Z.architecture = 64, Z.family = Z.family.replace(RegExp(" *" + a), "")), G && (/\bWOW64\b/i.test(n) || C && /\w(?:86|32)$/.test(o.cpuClass || o.platform) && !/\bWin64; x64\b/i.test(n)) && k.unshift("32-bit")) : Z && /^OS X/.test(Z.family) && "Chrome" == G && parseFloat(D) >= 39 && (Z.architecture = 64), n || (n = null);
                var P = {};
                return P.description = n, P.layout = L && L[0], P.manufacturer = R, P.name = G, P.prerelease = O, P.product = Q, P.ua = n, P.version = G && D, P.os = Z || {
                    architecture: null,
                    family: null,
                    version: null,
                    toString: function () {
                ...
                }, P.version && k.unshift(D), P.name && k.unshift(G), Z && G && (Z != String(Z).split(" ")[0] || Z != G.split(" ")[0] && !Q) && k.push(Q ? "(" + Z + ")" : "on " + Z), k.length && (P.description = k.join(" ")), P
            }();
    ...
    e.exports = function (e) {
        ...
        return n.toString = function () {
            return this.map((function (n) {
                var t = function (e, n) {
                    ...
                    if (n && "function" == typeof btoa) {
                        var o = (s = r, a = btoa(unescape(encodeURIComponent(JSON.stringify(s)))), A = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), "/*# ".concat(A, " */")),
            ...
            for (var s = 0; s < e.length; s++) {
                var a = e[s];
                null != a[0] && r[a[0]] || (t && !a[2] ? a[2] = t : t && (a[2] = "(".concat(a[2], ") and (").concat(t, ")")), n.push(a))
            }
        }, n
    }
}, function (e, n, t) {
    ...
    (l || c) && (A = function (e) {
        var n, t, r, o, A = this;
        return c && (t = new RegExp("^" + A.source + "$(?!\\s)", i.call(A))), l && (n = A.lastIndex), r = s.call(A, e), l && r && (A.lastIndex = A.global ? r.index + r[0].length : n), c && r && r.length > 1 && a.call(r[0], t, (function () {
    ...
    var r = function (e) {
        ...
        function w(e, t) {
            ...
            var i = o.arg;
            return i ? i.done ? (t[e.resultName] = i.value, t.next = e.nextLoc, "return" !== t.method && (t.method = "next", t.arg = n), t.delegate = null, p) : i : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, p)
        }
        ...
        return h.prototype = M.constructor = j, j.constructor = h, j[a] = h.displayName = "GeneratorFunction", e.isGeneratorFunction = function (e) {
            var n = "function" == typeof e && e.constructor;
            return !!n && (n === h || "GeneratorFunction" === (n.displayName || n.name))
        }, e.mark = function (e) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(e, j) : (e.__proto__ = j, a in e || (e[a] = "GeneratorFunction")), e.prototype = Object.create(M), e
        }, e.awrap = function (e) {
            return {
                __await: e
            }
    ...
    var r = t(2),
        ...
        A = function () {
            var e, n = t(42)("iframe"),
                r = i.length;
            for (n.style.display = "none", t(65).appendChild(n), n.src = "javascript:", (e = n.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), A = e.F; r--;) delete A.prototype[i[r]];
            return A()
        };
    e.exports = Object.create || function (e, n) {
        var t;
        return null !== e ? (a.prototype = r(e), t = new a, a.prototype = null, t[s] = e) : t = A(), void 0 === n ? t : o(t, n)
    }
}, function (e, n, t) {
    "use strict";
    var r = t(63),
    ...
    t(61)("split", 2, (function (e, n, t, c) {
        var p;
        return p = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (e, n) {
            var o = String(this);
            if (void 0 === e && 0 === n) return [];
            if (!r(e)) return t.call(o, e, n);
            for (var i, s, a, A = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, f = void 0 === n ? 4294967295 : n >>> 0, p = new RegExp(e.source, c + "g");
                (i = l.call(p, o)) && !((s = p.lastIndex) > u && (A.push(o.slice(u, i.index)), i.length > 1 && i.index < o.length && v.apply(A, i.slice(1)), a = i[0].length, u = s, A.length >= f));) p.lastIndex === i.index && p.lastIndex++;
    ...
    t(61)("replace", 2, (function (e, n, t, p) {
        return [function (r, o) {
            ...
            for (var m, M = "", y = 0, z = 0; z < g.length; z++) {
                b = g[z];
                for (var w = String(b[0]), I = l(c(s(b.index), v.length), 0), x = [], E = 1; E < b.length; E++) x.push(void 0 === (m = b[E]) ? m : String(m));
                var N = b.groups;
                if (f) {
    ...
    v && f || (v = function (e) {
        ...
        d.now(s(g, e, 1))
    } : p ? (i = (o = new p).port2, o.port1.onmessage = b, r = s(i.postMessage, i, 1)) : c.addEventListener && "function" == typeof postMessage && !c.importScripts ? (r = function (e) {
        c.postMessage(e + "", "*")
    ...
    (function (n) {
        ...
        var a, A = {
            adapter: (void 0 !== n && "[object process]" === Object.prototype.toString.call(n) ? a = t(75) : "undefined" != typeof XMLHttpRequest && (a = t(75)), a),
            transformRequest: [function (e, n) {
                return o(n, "Accept"), o(n, "Content-Type"), r.isFormData(e) || r.isArrayBuffer(e) || r.isBuffer(e) || r.isStream(e) || r.isFile(e) || r.isBlob(e) ? e : r.isArrayBufferView(e) ? e.buffer : r.isURLSearchParams(e) ? (s(n, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : r.isObject(e) ? (s(n, "application/json;charset=utf-8"), JSON.stringify(e)) : e
            }],
    ...
    e.exports = function (e) {
        return new Promise((function (n, l) {
            ...
            if (v.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0), v.timeout = e.timeout, v.onreadystatechange = function () {
    ...
    e.exports = function (e, n) {
        ...
        return r.forEach(["url", "method", "params", "data"], (function (e) {
            ...
            r.isObject(n[o]) ? t[o] = r.deepMerge(e[o], n[o]) : void 0 !== n[o] ? t[o] = n[o] : r.isObject(e[o]) ? t[o] = r.deepMerge(e[o]) : void 0 !== e[o] && (t[o] = e[o])
    ...
    e.exports = function (e, n) {
        ...
        if (Object.getOwnPropertySymbols) {
            ...
            for (o = 0; o < s.length; o++) t = s[o], n.indexOf(t) >= 0 || Object.prototype.propertyIsEnumerable.call(e, t) && (i[t] = e[t])
        }
        return i
    }
}, function (e, n, t) {
    ...
    e.exports = !l || t(7)((function () {
        ...
        for (var t = a(e), l = arguments.length, c = 1, u = i.f, v = s.f; l > c;)
            for (var f, p = A(arguments[c++]), d = u ? o(p).concat(u(p)) : o(p), h = d.length, j = 0; h > j;) f = d[j++], r && !v.call(p, f) || (t[f] = p[f]);
        return t
    } : l
}, function (e, n, t) {
    var r = t(31),
    ...
    e.exports = function (e) {
        return function (n, t) {
            var i, s, a = String(o(n)),
                A = r(t),
                l = a.length;
            return A < 0 || A >= l ? e ? "" : void 0 : (i = a.charCodeAt(A)) < 55296 || i > 56319 || A + 1 === l || (s = a.charCodeAt(A + 1)) < 56320 || s > 57343 ? e ? a.charAt(A) : i : e ? a.slice(A, A + 2) : s - 56320 + (i - 55296 << 10) + 65536
        }
    }
}, function (e, n, t) {
    "use strict";
    ...
    if (!f(" 0o1") || !f("0b1") || f("+0x1")) {
        ...
        for (var b, m = t(4) ? l(p) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), M = 0; m.length > M; M++) o(p, b = m[M]) && !o(f, b) && u(f, b, c(p, b));
    ...
    e.exports = function (e, n, t, p, d, h, j) {
        ...
        if (T && (m = c(T.call(new e))) !== Object.prototype && m.next && (l(m, y, !0), r || "function" == typeof m[u] || s(m, u, f)), z && x && "values" !== x.name && (w = !0, E = function () {
                return x.call(this)
    ...
    var r, o, i, s, a = t(22),
        ...
        S = !! function () {
            try {
                ...
                return (N || "function" == typeof PromiseRejectionEvent) && e.then(T) instanceof n && 0 !== x.indexOf("6.6") && -1 === M.indexOf("Chrome/66")
            } catch (e) {}
        }(),
        B = function (e) {
            var n;
                ...
                g((function () {
                    for (var r = e._v, o = 1 == e._s, i = 0, s = function (n) {
                            var t, i, s, a = o ? n.ok : n.fail,
                                ...
                                c = n.domain;
                            try {
                                a ? (o || (2 == e._h && D(e), e._h = 1), !0 === a ? t = r : (c && c.enter(), t = a(r), c && (c.exit(), s = !0)), t === n.promise ? l(z("Promise-chain cycle")) : (i = B(t)) ? i.call(t, A, l) : A(t)) : l(r)
                            } catch (e) {
                                c && !s && c.exit(), l(e)
                            }
                        }; t.length > i;) s(t[i++]);
    ...
    S || (E = function (e) {
        ...
        then: function (e, n) {
            var t = Y(h(this, E));
            return t.ok = "function" != typeof e || e, t.fail = "function" == typeof n && n, t.domain = N ? w.domain : void 0, this._c.push(t), this._a && this._a.push(t), this._s && k(this, !1), t.promise
        },
        catch: function (e) {
    ...
    r(r.S, "Object", {
        getOwnPropertyDescriptors: function (e) {
            for (var n, t, r = i(e), A = s.f, l = o(r), c = {}, u = 0; l.length > u;) void 0 !== (t = A(r, n = l[u++])) && a(c, n, t);
            return c
        }
    })
}, function (e, n, t) {
    ...
    var r = t(1),
        ...
        X = function (e, n, t) {
            return e === F && X(Z, n, t), g(e), n = y(n, !0), g(t), o(R, n) ? (t.enumerable ? (o(e, D) && e[D][n] && (e[D][n] = !1), t = w(t, {
                enumerable: z(0, !1)
        ...
        ee = function (e) {
            for (var n, t = e === F, r = B(t ? Z : M(e)), i = [], s = 0; r.length > s;) !o(R, n = r[s++]) || t && !o(F, n) || i.push(R[n]);
            return i
        };
    P || (a((k = function () {
        ...
        return this._k
    })), x.f = q, N.f = X, t(36).f = I.f = $, t(33).f = K, E.f = ee, i && !t(22) && a(F, "propertyIsEnumerable", K, !0), p.f = function (e) {
        return H(f(e))
    }), s(s.G + s.W + s.F * !P, {
        Symbol: k
    });
    ...
    }), k.prototype[L] || t(11)(k.prototype, L, k.prototype.valueOf), u(k, "Symbol"), u(Math, "Math", !0), u(r.JSON, "JSON", !0)
}, function (e, n, t) {
    var r = t(21)("meta"),
        o = t(9),
        i = t(12),
    ...
    e.exports = function (e) {
        return l(e), e.baseURL && !a(e.url) && (e.url = A(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = o(e.data, e.headers, e.transformRequest), e.headers = r.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), r.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function (n) {
            delete e.headers[n]
        })), (e.adapter || s.adapter)(e).then((function (n) {
            return l(e), n.data = o(n.data, n.headers, e.transformResponse), n
        }), (function (n) {
            return i(n) || (l(e), n && n.response && (n.response.data = o(n.response.data, n.response.headers, e.transformResponse))), Promise.reject(n)
        }))
    }
}, function (e, n, t) {
    "use strict";
    ...
    e.exports = r.isStandardBrowserEnv() ? {
        write: function (e, n, t, o, i, s) {
            var a = [];
            a.push(e + "=" + encodeURIComponent(n)), r.isNumber(t) && a.push("expires=" + new Date(t).toGMTString()), r.isString(o) && a.push("path=" + o), r.isString(i) && a.push("domain=" + i), !0 === s && a.push("secure"), document.cookie = a.join("; ")
        },
        read: function (e) {
    ...
    var r = t(26),
        ...
        M = t(17),
        y = t.n(M),
        z = ["./static/public.js", "./static/md5.js", "./static/mp4remux.js", "./static/videoMediaSource.js", "./static/WebsocketServer.js","./static/WebGLCanvas.js", "./static/Sylvester.js", "./static/audioPlayer.js", "./static/workerManager.js", "./static/streamDrawer.js", "./static/playerControl.js", "./static/ivs.js"],
            ...
            function e(n) {
                ...
                Object.defineProperty(this.playerStatus, "isMuted", {
                    ...
                    set: function (e) {
                        ...
                        }), 500), t.setVolume(e ? 0 : 1), p.setAttr(t.btnSound, "class", "player__btn player__btn-large iconfont icon".concat(e ? "jingyin" : "shengyin")), r = e
                    }
                }), this.isMobile = n.isMobile, this.root = document.createElement("div"), p.setStyle(this.root, {
                    width: "100%",
                    height: "100%",
                    position: "relative"
                }), this.urlParams = this.checkData(n.urlParams, n.type), console.log(this.urlParams), this.options = n, this.options.root.appendChild(this.root), this.init(this.options)
            }
            return v()(e, [{
                key: "checkData",
                value: function (e, n) {
                    var t = e.streamId,
                        ...
                        c = this.isMobile;
                    t || (t = 1), r || (r = "http:" === location.protocol ? "1" : "2"), o || (c ? o = "hls" : l ? "1" === n && 1 === t ? o = "hls" : (o = "rtsp", this.browserWarn()) : o = "rtsp");
                ...
                value: function (e) {
                    var n = this;
                    this.btnPlay = e.querySelector("#playerControls"), this.btnStop = e.querySelector("#playerStop"), this.btnSound = e.querySelector("#playerSound"), this.btnFullScreen = e.querySelector("#playerFullScreen"), this.playerControls = e.querySelector(".player__controls"), this.btnPlay.addEventListener("click", this.playOrPause.bind(this)), this.btnStop.addEventListener("click", this.stop.bind(this)), this.root.addEventListener("mouseenter", this.showControl.bind(this)), this.root.addEventListener("mousemove", this.showControl.bind(this)), this.btnFullScreen && this.btnFullScreen.addEventListener("click", (function () {
                ...
                key: "play",
                value: function () {
                    this.isPlaying = !0, this.controls && p.setAttr(this.btnPlay, "class", "player__btn player__btn-large iconfont iconbofangzanting"), this.poster && (this.poster.style.display = "none"), this.canvasPlayer ? (console.info("canvas play"), this.canvasPlayer.play()) : this.videoJsPlayer ? (console.info("videojs play"), this.videoJsPlayer.play()) : this.videoPlayer ? (console.info("videoh5 play"), this.videoPlayer.play()) : (console.info("other play"), this.createPlayerInstance())
                }
            }, {
                key: "pause",
                value: function () {
                    this.isPlaying = !1, p.setAttr(this.btnPlay, "class", "player__btn player__btn-large iconfont iconbofang"), this.canvasPlayer && this.canvasPlayer.pause(), this.videoJsPlayer && this.videoJsPlayer.pause(), this.videoPlayer && this.videoPlayer.pause()
                }
            }, {
                key: "stop",
                value: function () {
                    this.playerStatus.isMuted = !1, this.videoJsPlayer && this.videoJsPlayer.dispose(), this.videoPlayer && this.root.removeChild(this.videoPlayer), this.canvasPlayer && (this.canvasPlayer.close(), this.canvasEl && this.root.removeChild(this.canvasEl), this.videoEl && this.root.removeChild(this.videoEl)), this.isPlaying = !1, this.canvasPlayer = null, this.videoJsPlayer = null, this.videoPlayer = null, p.setAttr(this.btnPlay, "class", "player__btn player__btn-large iconfont iconbofang"), this.tipDom.innerHTML = ""
                }
            }, {
                key: "setVolume",
                value: function (e) {
                    "number" == typeof e ? e > 1 || e < 0 ? E("Param of volume must be between from 0 to 1") : (this.videoJsPlayer && (this.videoJsPlayer.muted(!e), this.videoJsPlayer.volume(e)), this.videoPlayer && (this.videoPlayer.muted = !e, this.videoPlayer.volume = e), this.canvasPlayer && this.canvasPlayer.setAudioVolume(e)) : E("Param of volume must be a number")
                }
            }, {
                key: "destroy",
                value: function () {
                    if (this.videoJsPlayer && this.videoJsPlayer.dispose(), this.videoPlayer && (this.root.removeChild(this.videoPlayer), this.videoPlayer = null), this.canvasPlayer) try {
                ...
                key: "init",
                value: function (e) {
                    this.tipDom = this.createTip(), this.controls = e.controls, e.controls && this.createControls(), e.poster && (this.poster = this.createPoster(e.poster)), e.autoplay && this.play()
                }
            }, {
                key: "getPlayUrl",
                value: function (e) {
                        ...
                        for (;;) switch (j.prev = j.next) {
                            case 0:
                                if (n = {
                                        ...
                                        isSuccess: !1,
                                        playUrl: ""
                                    }, t = e.kitToken, r = e.deviceId, o = e.channelId, i = e.type, j.prev = 2, s = location, -1 !== s.protocol.indexOf("http")) {
                                    j.next = 8;
                                    break
                                }
                                return E("Please open on HTTP or HTTPS"), n.message = "Please open on HTTP or HTTPS", j.abrupt("return", n);
                            case 8:
                                return a = p.transformParamsToString(this.urlParams), l = (new Date).getTime(), j.next = 12, A.a.awrap(m()({
                            ...
                            case 12:
                                c = j.sent, console.log(c), u = (new Date).getTime() - l, console.log("获取播放地址耗时: ".concat(u / 1e3, "s")), v = c.data, 200 === c.status ? (f = v.result.data, d = v.result.code, h = v.result.msg, "0" === d ? (n.playUrl = f.url, n.isSuccess = !0) : n.message = h || "获取播放地址失败") : n.message = "获取播放地址失败", j.next = 24;
                                break;
                            case 20:
                ...
                value: function () {
                    ...
                    return A.a.async((function (h) {
                        for (;;) switch (h.prev = h.next) {
                            ...
                            case 6:
                                return this.playUrl = e.playUrl, this.isRecord = p.isRecord(this.playUrl), h.next = 10, A.a.awrap(this.loadScripts());
                            case 10:
                                if (!this.isRecord) {
                                    h.next = 46;
                                    break
                                }
                                if (n = document.createElement("video"), t = document.createElement("source"), p.setAttr(t, "src", this.playUrl), p.setAttr(n, "playsinline", !0), p.setAttr(n, "webkit-playsinline", !0), p.setAttr(n, "x5-playsinline", !0), p.setStyle(n, {
                                        width: "100%",
                                        height: "100%",
                                        objectFit: "fill"
                                ...
                                console.log("video play"), n.controls = !1, n.autoplay = !0, n.appendChild(t), this.root.appendChild(n), this.videoPlayer = n;
                                try {
                                    setTimeout((function () {
                                        n.play()
                            ...
                            case 30:
                                ...
                                })), h.prev = 36, h.next = 39, A.a.awrap(this.videoJsPlayer.play());
                            case 39:
                                h.next = 44;
                                break;
                            case 41:
                                h.prev = 41, h.t0 = h.catch(36), this.tipDom.innerHTML = "播放出错";
                            case 44:
                                h.next = 73;
                                break;
                            case 46:
                            ...
                            case 49:
                                this.canvasEl = document.createElement("canvas"), this.videoEl = document.createElement("video"), this.canvasEl.style.width = "100%", this.canvasEl.style.height = "100%", this.canvasEl.style.display = "none", this.videoEl.style.width = "100%", this.videoEl.style.height = "100%", this.videoEl.style.display = "none", this.root.appendChild(this.canvasEl), this.root.appendChild(this.videoEl), this.frameTime = null, a = this.playUrl.replace("rtsp://", "").split("/"), l = s()(a, 1), c = l[0], u = location, v = u.protocol, f = {
                                    ...
                                    d.isPlaying = !0
                                })), this.canvasPlayer.on("Error", (function (e) {})), this.canvasPlayer.on("UpdateCanvas", (function (e) {
                                ...
                                })), this.startGetStreamTime = (new Date).getTime(), this.canvasPlayer.init(this.canvasEl, this.videoEl), this.canvasPlayer.setAudioVolume(1), this.canvasPlayer.connect();
                            case 73:
                            case "end":
                                return h.stop()
                        }
            ...
            return v()(e, [{
                ...
                value: function (e) {
                    ...
                    return A.a.async((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                (!e.src || !e.src instanceof Array) && Y("请填写正确的src"), this.options = e, this.options.url = this.options.src, void 0 === this.options.controls && (this.options.controls = !0), void 0 === this.options.autoplay && (this.options.autoplay = !0), n = !1 === this.options.controls ? "100%" : "calc(100% - 40px)", p.setStyle(this.container, {
                                    height: n
                ...
                key: "setVolume",
                value: function (e) {
                    "number" == typeof e ? e > 1 || e < 0 ? Y("Param of volume must be between from 0 to 1") : this.playerSet.forEach((function (n) {
                        n.setVolume(e)
                ...
                value: function () {
                    ...
                    if (!this.isFullScreen) {
                        var n = e.requestFullScreen || e.webkitRequestFullScreen || e.mozRequestFullScreen || document.body.msRequestFullscreen;
                        if (n) n.call(e);
                        else {
                            var t = document.getElementsByTagName("video");
                            s()(t, 1)[0].webkitEnterFullScreen()
                        }
                        this.btnFullScreen && p.setAttr(this.btnFullScreen, "class", "player__btn player__btn-large iconfont icontuichuquanping")
                    }
                ...
                key: "exitFullScreen",
                value: function () {
                    this.isFullScreen && ((document.exitFullScreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen).call(document), this.btnFullScreen && p.setAttr(this.btnFullScreen, "class", "player__btn player__btn-large iconfont iconquanping"));
                ...
                value: function () {
                    ...
                    var n = this.options,
                        ...
                        s = void 0 === i ? "400" : i,
                        a = ["string", "number"];
                    a.includes(o()(r)) && a.includes(o()(s)) ? ("number" == typeof r ? e.width = "".concat(r, "px") : -1 === r.indexOf("px") && -1 === r.indexOf("%") ? e.width = "".concat(r, "px") : e.width = r, "number" == typeof s ? e.height = "".concat(s, "px") : -1 === s.indexOf("px") && -1 === s.indexOf("%") ? e.height = "".concat(s, "px") : e.height = s, p.setStyle(this.root, e)) : Y('Type of "width" or "height" must be String or Number')
                }
            }, {
                ...
                value: function (e) {
                    var n = this;
                    this.btnFullScreen = e.querySelector("#playerFullScreen"), this.playerSplit1 = e.querySelector("#playerSplit1"), this.playerSplit2 = e.querySelector("#playerSplit2"), this.playerSplit4 = e.querySelector("#playerSplit4"), this.playerSplit9 = e.querySelector("#playerSplit9"), this.playerSplit1.addEventListener("click", this.setMultiScreen.bind(this, 1)), this.playerSplit2.addEventListener("click", this.setMultiScreen.bind(this, 2)), this.playerSplit4.addEventListener("click", this.setMultiScreen.bind(this, 4)), this.playerSplit9.addEventListener("click", this.setMultiScreen.bind(this, 9)), "iOS" !== y.a.os.family && (this.btnFullScreen.addEventListener("click", this._toggleFullScreen.bind(this)), window.addEventListener("keydown", (function (e) {
                        var t = e.keyCode || e.which;
                        n.isFullScreen && 27 === t && (console.info("esc"), n._toggleFullScreen.call(n))
                    })), document.addEventListener("webkitfullscreenchange", (function (e) {
                        e.currentTarget.webkitIsFullScreen || n.exitFullScreen.call(n)
                    })), document.addEventListener("fullscreenchange", (function (e) {
                        document.fullscreen || n.exitFullScreen.call(n)
                    })))
                }
            }, {
                key: "_analysisUrl",
                value: function (e) {
                    var n = {},
                        ...
                        c = A[1],
                        u = A[2];
                    if (/^[0-9A-Za-z]+$/i.test(l) && /^\d{1,3}$/.test(c) && ["1", "2"].includes(u)) return i && i.split("&").forEach((function (e) {
                        var t = e.split("="),
                            r = s()(t, 2),
                            o = r[0],
                            i = r[1];
                ...
                value: function (e) {
                    var n = !1,
                        t = y.a.name;
                    return ("Firefox" === t || "IE" === t || "Microsoft Edge" === t) && e.streamType && "rtsp" === e.streamType && (n = !0), n
                }
            }, {
                key: "renderPlayer",
                value: function (e, n) {
                    ...
                    2 === n && (a.width = "50%", a.height = "50%"), 4 === n && (a.width = "50%", a.height = "50%"), 9 === n && (a.width = "33.33%", a.height = "33.33%"), p.setAttr(this.container, "class", "player__split--".concat(n));
                    for (var A = [], l = 0, c = this.container.children.length; l < c; l++) l > n - 1 ? (this.container.removeChild(this.container.children[n]), this.playerSet[l] && this.playerSet[l].destroy()) : "true" === this.container.children[l].dataset.player && A.push(this.container.children[l]);
                    for (var u = 0; u < A.length; u++) A[u].style.width = a.width, A[u].style.height = a.height, 2 === n ? p.setStyle(A[u], {
